...
public class ResponseDto<T> {
    ...
    // private final Integer status; // HTTP 상태 코드 정수 값 (예: 200, 400, 403 등)
    // private final String code; // 에러 코드 문자열 (예: VALIDATION_ERROR, NOT_FOUND_USER 등)

    // private final Integer timestamp; // 응답 시각
    //      >> Instant.now()
     ...
     *
      */
    public static <T> ResponseDto<T> setSuccess(String massage, T data) {
        return ResponseDto.set(true, massage, data);
    }
