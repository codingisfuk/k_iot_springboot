...
/*
   ...
   2. RESTful API란?
    ...
    5) 계층 구조 표현 - 관계는 / 로 표현
        (O) /users/{userId}/orders/{ordersId} - 특정 사용자(userId)의 주문들 중 특정 주문(orderId)
    ...
    케이스1) 사용자/인증
        ...
        - 이메일 중복 체크: GET /apu/v1/auth/check-email?email=XXX...)

    케이스2) 쇼핑몰
        - 상품 목록: GET /aip/v1/products
        - 상품 리뷰 조회: GET /api/v1/products/{productUd}/reviews
