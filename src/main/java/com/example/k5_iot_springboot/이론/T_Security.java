...
/*
    ...
    : Spring Framework  기반 애플리케이션 보안(인증, 인가, 권한)을 담당하는 보안 프레임워크
    ...
    - 사용자가 로그인 기능을 통해 아이디, 비밀번화를 입력하면
    ...
    1. HTTP는 무상태(Stateless)
        ...
        - 서버는 이전 요청에 대한 사용자 정보를 정보를 기억하지 않음 (매번 로그인 정보를 다시 제출해야 함)
   ...
   2) SecurityFilterChain - 검문소 라인
        ...
        - JWT 토근이 있는지(JwtAuthenticationFilter, 커스텀 Filter에 전달)
        - 보호된 URL인지 확인
