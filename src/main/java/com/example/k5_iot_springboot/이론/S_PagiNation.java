...
/*
* === 페이지네이션(Pagination) ===
* : 여러 개의 데이터를 페이지 기반으로 나누어서 요청하는 방식
*
* 1) 페이지네이션 목적
* 성능/비용: 대용량 데이터 전체 조회 방지, DB/네트워크 부하 종결
* - UX: 목록을 나누어 보여주거나 "더보기/무한스크롤" 제공
*
* 2) 페이지네이션 기본 용어
*   - page: 몇 번째 페이지 (0 부터 시작)
...
*           , 페이지 점프가 필요한 UI
*
*       +) 페이지 번호(page)와 크기(size)로 건너뛸 개수(offset)
*           LIMIT size OFFSET offset
*
*   2) Cursor(Keyset) 기반(cursorId/size)
*       - 요청: /boards/cursor?cursorId=마지막아이템id&siae=10
